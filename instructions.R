...
#Simply remove the missing values, because dividing up stuff seems too complex, plus pri jet is a factor
...
ctrl = trainControl(method = "oob", number = 5, p = .80, summaryFunction = AMS_summary)
